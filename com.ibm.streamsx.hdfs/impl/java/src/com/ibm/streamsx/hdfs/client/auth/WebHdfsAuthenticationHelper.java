...
public class WebHdfsAuthenticationHelper extends BaseAuthenticationHelper {
	...
	private URI formatUriWithCredFile(URI fileSystemUri, String credFilePath)
			throws Exception {
		...
		URI webHdfsUri = new URI(fileSystemUri.getScheme(), userInfo,
				fileSystemUri.getHost(), fileSystemUri.getPort(), "/", null,
				null);
