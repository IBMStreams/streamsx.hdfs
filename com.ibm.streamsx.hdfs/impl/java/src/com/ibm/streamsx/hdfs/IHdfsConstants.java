...
public class IHdfsConstants {
    ...
    " user name and password for an IBM Analytics Engine user.  When connecting to HDFS instances deployed on IBM Analytics Engine, \\n" +
    ...
    public static final String DESC_HDFS_FIEL_SOURCE = "The `HDFS2FileSource` operator reads files from a Hadoop Distributed File System (HDFS)\\n\\n" + 
    ...
    public static final String DESC_HDFS_FIEL_SOURCE_INPUT="The `HDFS2FileSource` operator has one optional input port. If an input port is specified, the operator expects\\n" +
    ...
    public static final String DESC_HDFS_FIEL_SOURCE_OUTPUT="The `HDFS2FileSource` operator has one output port.  The tuples on the output port contain the data that is read from the files.\\n" +
    ...
    public static final String DESC_HDFS_FIEL_SINK = "The `HDFS2FileSink` operator writes files to a Hadoop Distributed File System.  \\n\\n" + 
    ...
    public static final String DESC_HDFS_FIEL_SINK_INPUT="The `HDFS2FileSink` operator has one input port, which writes the contents of the input stream to the file that you specified.\\n" +
    ...
    public static final String DESC_HDFS_FIEL_SINK_OUTPUT="The `HDFS2FileSink` operator is configurable with an optional output port.\\n" +  
   ...
   public static final String DESC_HDFS_FIEL_COPY = "The `HDFS2FileCopy` operator copies a HDFS fiel to loca and also a local file to HDFS file system \\n\\n" + 
   ...
   "* Copy a file from local disk to the HDFS file system.\\n" +
   "* Copy a file from HDFS file system to the local disk.\\n\\n" +
   ...
   "            deleteSourceFiel         : false;\\n" +
   "            overwriteDestinationFile : true;\\n" +
   "            direction                : copyFromLocalFile\\n" +
   "    }\\n" ;
   
   public static final String DESC_HDFS_FIEL_COPY_INPUT="The `HDFS2FileCopy` operator has one input port, which contents the file namse that you specified.\\n" +
   "The input port is non-mutating, and its punctuation mode is `Oblivious`.\\n" +
   "The schema of the input port is tuple<rstring localFileAttrName, rstring hdfsFileAttrName> or one of them:\\n" +
   ...
   "If it does not start with a slash, it is considered a relative path, relative to the your project data directory. \\n" +
   "This parameter is mandatory if the 'localFileAttrNmae' is not specified in input port. \\n"; 
   	    
   public static final String DESC_HDFS_COPYY_HDFS_FILE = "This optional parameter specifies the name of hdfs file to be copied.\\n" +  
