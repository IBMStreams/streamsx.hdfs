...
import com.ibm.streamsx.hdfs.client.webhdfs.KerberosUgiAuthenticator;
...
public class URLConnectionFactory {
	...
	protected final ConnectionConfigurator connConfigurator;

	public static final ConnectionConfigurator DEFAULT_TIMEOUT_CONN_CONFIGURATOR = new ConnectionConfigurator() {
		@Override
	...
	@VisibleForTesting
	protected URLConnectionFactory(ConnectionConfigurator connConfigurator) {
